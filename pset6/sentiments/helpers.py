...
def get_user_timeline(screen_name, count=200):
    ...
    if not os.environ.get("API_KEY"):                 #API Key: SpgMfkO9f6qNZpPFnm5djVsPF
        raise RuntimeError("API_KEY not set")         #API secret : vp0NYMwfBt8UXC8ptiNSWMZyeu2YOgc1oKRMdci3T7FSx4XHOk
