...
@app.route("/")
def index():                                        #API key AIzaSyBHcMtALhvNxbbWeJVWHwXplHOJbZjyN5w
    """Render map."""
...
def articles():
    ...
    #retrieve geo arguments from HTML form
    geo = request.args.get("geo")

    if not geo:  #if argument missing raise runtime error
...
def search():
    ...
    #retrun upto 10 places found as JSON object
    if len(place) > 10:
        return jsonify([place[0], place[1], place[2], place[2], place[4], place[5], place[6],place[7],
        place[8],place[9]])
    else:
